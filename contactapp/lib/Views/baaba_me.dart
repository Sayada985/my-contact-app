...
class Baaba extends StatelessWidget {
  const Baaba({ Key? key }) : super(key: key);
          ...
          child: Column(
            children:[
              ...
              const Padding(
                ...
                child: CircleAvatar(
                  backgroundImage:AssetImage('assets/images/Baaba.jpg') ,
                  radius: 80,
                ),
              ),
              const Text('Baaba',
              ...
              color: Color.fromRGBO(51, 51, 51, 1),),
               ...
               ListTile( 
                ...
                subtitle: const Text('0540569092',
                style: TextStyle(
                  fontStyle:FontStyle.normal,
