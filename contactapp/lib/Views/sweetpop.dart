...
class SweetPop extends StatelessWidget {
  const SweetPop({ Key? key }) : super(key: key);
          ...
          child: Column(
            children:[
              ...
              const Padding(
                ...
                child: CircleAvatar(
                  backgroundImage:AssetImage('assets/images/Sweetpop.jpg') ,
                  radius: 80,
                ),
              ),
              const Text('Sweet pop',
              ...
              color: Color.fromRGBO(51, 51, 51, 1),),
               ...
               ListTile( 
                ...
                subtitle: const Text('0244122816',
                style: TextStyle(
                  fontStyle:FontStyle.normal,
              ...
              const ListTile( 
                ...
                style: TextStyle(
                  ...
                  color: Colors.black,
                  fontWeight: FontWeight.w700),), 
                subtitle: Text('ambassador@gmail.com',
                style: TextStyle(
                  fontStyle:FontStyle.normal,
                  fontWeight:FontWeight.w500,
                  color:Color.fromRGBO(51, 51, 51, 1)),),
