...
class SweetMom extends StatelessWidget {
  const SweetMom({ Key? key }) : super(key: key);
          ...
          child: Column(
            children:[
              ...
              const Padding(
                ...
                child: CircleAvatar(
                  backgroundImage:AssetImage('assets/images/Sweetmom.jpg') ,
                  radius: 80,
                ),
              ),
              const Text('Sweet mom',
              ...
              color: Color.fromRGBO(51, 51, 51, 1),),
               ...
               ListTile( 
                ...
                subtitle: const Text('0266781728',
                style: TextStyle(
                  fontStyle:FontStyle.normal,
              ...
              const ListTile( 
                ...
                style: TextStyle(
                  ...
                  color: Colors.black,
                  fontWeight: FontWeight.w700),), 
                subtitle: Text('mallama@gmail.com',
                style: TextStyle(
                  fontStyle:FontStyle.normal,
                  fontWeight:FontWeight.w500,
                  color:Color.fromRGBO(51, 51, 51, 1)),),
